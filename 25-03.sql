...
INSERT INTO public.posts VALUES (5, 'sddsddd', 'sddsddd', 'posts/post-YZYX168.jpg', '<p>qweqeqdfgdg</p>', true, 1, '2024-03-14 10:04:25', '2024-03-14 03:04:30', '2024-03-14 03:05:26');
...
INSERT INTO public.products VALUES (1, 'Маслопресс YZY260', 'maslopress-yzy260', '["products\/IMG_20230915_110013.jpg"]', '<p><strong>1. Сфера использования</strong></p><p>Модель YZY260 представляет собой масляный пресс двойного назначения с непрерывным шнековым прессованием и предварительным прессованием, который подходит для заводов по производству растительных масел для обработки ядер арахиса, семян хлопчатника, рапса, семян подсолнечника, зародышей кукурузы и других семян растительного масла с высоким содержанием масла.</p><p><strong>2. Характеристики и особенности</strong></p><p>Масляный пресс YZY260 имеет две функции: прессование и предварительное прессование. При нормальных условиях предварительной обработки основные рабочие характеристики следующие:</p><p>1. Большая производительность обработки, небольшая площадь цеха и небольшое энергопотребление.</p><p>2. Структура предварительно прессованного жмыха рыхлая и рыхлая, что способствует проникновению растворителя.</p><p>3. Содержание масла и влаги в прессованном жмыхе подходит для выщелачивания растворителем.</p><p>4. Шнек камеры пресса использует передовые технологии, такие как легкое прессование, частое прессование и поэтапное повышение давления, что приводит к низкому остаточному маслу.</p><p>5. В механизме выхода жмыха используется запатентованная технология червячной передачи и червяка, которая не требует парковки, что делает калибровку простой и быстрой.</p><p>6. Клетка пресса имеет аксиальное разделение, что облегчает сборку и обслуживание, а также снижает трудоемкость.</p><p>7. На торцевой поверхности прижимного винта имеется лабиринтное уплотнение, которое решает проблему соединения поверхности прижимного винта и остатков утечки масла.</p><p>8. Качество добываемой нефти высокое и скорость переработки высокая.</p><p>9. Выходная мощность этой машины и экстрактора хорошо совпадают.</p><p>10. Постепенное повышение давления, переворачивание материалов под давлением, может эффективно решить проблему затруднений при сжатии зародышей кукурузы, копры, рапса, рисовых отрубей и других масличных культур.</p><p><strong>3. Основные технические параметры</strong></p><p>1. Производительность переработки:&nbsp; 40-50 тонн/24 часа</p><p>2. Оборудованный двигатель: 75 кВт (основной двигатель)</p><p>&nbsp; &nbsp; &nbsp; &nbsp;GFAF67-22,05-M4-φ45 (редуктор)</p><p>3. Толщина выходящего жмыха: 15-20 мм.</p><p>4. Остаточное масло в жмыхе: предварительно прессованное от 13% до 17%, прессованное от 5% до 7%.</p><p>5. Габаритные размеры: 3800*2320*1800 (длина*ширина*высота) (Д*Ш*В)</p><p>6. Вес нетто: около 6800 кг.</p>', true, true, false, 2, '2024-03-13 03:51:58', '2024-03-25 04:54:45');
