...
CREATE TABLE public.products (
    ...
    body character varying(9048) NOT NULL,
...
INSERT INTO public.product_categories VALUES (4, 'Жаровня паровая', 'zharovniy-parovaya', 'product_category/thumbs_zarovniy.png', '', '', 0, '2024-03-07 03:53:27', '2024-03-07 03:53:27');
INSERT INTO public.product_categories VALUES (3, 'Маслофильтры', 'oil-filters', 'product_category/oil_filter.jpg', '', '', 0, '2024-03-07 03:53:27', '2024-03-07 03:53:27');
INSERT INTO public.product_categories VALUES (2, 'Маслопрессы', 'oil-presses', 'product_category/category-oil-press.png', '', '', 0, '2024-03-07 03:53:27', '2024-03-07 03:53:27');
INSERT INTO public.product_categories VALUES (5, 'Запчасти', 'zapchasty', 'product_category/thumbs.zip.png', '', '', 0, '2024-03-07 03:53:27', '2024-03-07 03:53:27');
INSERT INTO public.product_categories VALUES (6, 'Экструдеры', 'exstrudery', 'product_category/thumbs.IMG_20230315_180410.jpg', '', '', 0, '2024-03-07 03:53:27', '2024-03-07 03:53:27');
...
INSERT INTO public.products VALUES (6, 'Маслопресс YZYX120-8', 'maslopress-yzyx120-8', '["products\/YZYX120-8.png","products\/YZYX120-8-1.png","products\/YZYX120-8-2.png","products\/YZYX120-8-3.png"]', '<p>Спиральные масляные станки серии YZYX120 - 8, выпускаемые нашей компанией, подходят для прессования различных растительных масел, таких как рапс, хлопчатобумажные семена, соевыебобы, орех арахиса, семена хума, семена тунга, семена подсолнечника и пальмовое ядро.&nbsp; Продукция имеет преимущества малого инвестирования, простой поддержки, простоты обслуживания, высокой адаптации к маслу, высокой эффективности выхода нефти, для средних и малых нефтяных заводов и поселковых индивидуальных предприятий очень подходит.</p>
<p>Наша компания эта серия моделей редукторов, постепенно была усовершенствована в редуктор с косозубым приводом, производительность сцепления зубьев хорошая, степень совпадения велика, улучшает несущую способность, так что передача редуктора стабильна, уменьшает шум, продлевает срок службы шестерни.&nbsp;</p>
<p><strong>Основные характеристики:</strong></p>
<p>Следующие параметры производительности относятся к семенам масличных культур среднего или выше уровня качества, которые могут быть достигнуты во время непрерывного горячего прессования после того, как операция прессования является нормальной и вспомогательное оборудование, такое как очистка, шелушение, дробление, прокатка, пропаривание и жарка, завершено, а также принят разумный процесс прессования.</p>
<table style="border-collapse: collapse; width: 100%; height: 223.906px;" border="1">
<tbody>
<tr style="height: 44.7812px;">
<td style="width: 19.255%; height: 44.7812px;">Наименование</td>
<td style="width: 19.255%; height: 44.7812px;">Производительность （ t / 24h )</td>
<td style="width: 19.255%; height: 44.7812px;">Остаток масла &nbsp; (%)</td>
<td style="width: 19.255%; height: 44.7812px;">Эффективность &nbsp; (%)</td>
<td style="width: 19.2575%; height: 44.7812px;">Расход э - э （ kW &amp; middot; h / t )</td>
</tr>
<tr style="height: 22.3906px;">
<td style="width: 19.255%; height: 22.3906px;">рапс</td>
<td style="width: 19.255%; height: 22.3906px;">&ge; 6.5</td>
<td style="width: 19.255%; height: 22.3906px;">&le; 7.6</td>
<td style="width: 19.255%; height: 22.3906px;">&ge; 82</td>
<td style="width: 19.2575%; height: 22.3906px;">&le; 34</td>
</tr>
<tr style="height: 22.3906px;">
<td style="width: 19.255%; height: 22.3906px;">семя хлопка</td>
<td style="width: 19.255%; height: 22.3906px;">&ge; 6.5</td>
<td style="width: 19.255%; height: 22.3906px;">&le; 6.8</td>
<td style="width: 19.255%; height: 22.3906px;">&ge; 77</td>
<td style="width: 19.2575%; height: 22.3906px;">&le; 54</td>
</tr>
<tr style="height: 22.3906px;">
<td style="width: 19.255%; height: 22.3906px;">соевые бобы</td>
<td style="width: 19.255%; height: 22.3906px;">&ge; 5.5</td>
<td style="width: 19.255%; height: 22.3906px;">&le; 6.5</td>
<td style="width: 19.255%; height: 22.3906px;">&ge; 67</td>
<td style="width: 19.2575%; height: 22.3906px;">&le; 51</td>
</tr>
<tr style="height: 22.3906px;">
<td style="width: 19.255%; height: 22.3906px;">ядро арахиса</td>
<td style="width: 19.255%; height: 22.3906px;">&ge; 6.5</td>
<td style="width: 19.255%; height: 22.3906px;">&le; 6.5</td>
<td style="width: 19.255%; height: 22.3906px;">&ge; 92.3</td>
<td style="width: 19.2575%; height: 22.3906px;">&le; 34</td>
</tr>
<tr style="height: 44.7812px;">
<td style="width: 19.255%; height: 44.7812px;">семя подсолничника</td>
<td style="width: 19.255%; height: 44.7812px;">&ge; 6.5</td>
<td style="width: 19.255%; height: 44.7812px;">&le; 7.6</td>
<td style="width: 19.255%; height: 44.7812px;">&ge; 82</td>
<td style="width: 19.2575%; height: 44.7812px;">&le; 34</td>
</tr>
<tr style="height: 22.3906px;">
<td style="width: 19.255%; height: 22.3906px;">лён</td>
<td style="width: 19.255%; height: 22.3906px;">&ge; 6.5</td>
<td style="width: 19.255%; height: 22.3906px;">&le; 7.6</td>
<td style="width: 19.255%; height: 22.3906px;">&ge; 82</td>
<td style="width: 19.2575%; height: 22.3906px;">&le; 34</td>
...
<tr style="height: 22.3906px;">
<td style="width: 19.255%; height: 22.3906px;">семя сафлона</td>
<td style="width: 19.255%; height: 22.3906px;">&ge; 6.5</td>
<td style="width: 19.255%; height: 22.3906px;">&le; 6.5</td>
<td style="width: 19.255%; height: 22.3906px;">&ge; 67</td>
<td style="width: 19.2575%; height: 22.3906px;">&le; 51</td>
...
<p>Примечание: ① Из-за различных сортов, качества и содержания масла в разных регионах, а также различий в условиях эксплуатации и других факторов, фактические результаты отличаются от параметров, перечисленных в таблице, это нормально.② Суточная производительность обработки (т/24 часа) относится к производительности обработки во время одного обычного горячего прессования. Если прессовка нажимается дважды или трижды (например, холодное прессование), производительность обработки должна составлять половину или одну треть ее значения. Во-первых, и так далее, чем больше проходов прессования, тем ниже производительность обработки.</p>
<p><strong>Технические характеристики:</strong></p>
<table style="border-collapse: collapse; width: 100%;" border="1">
<tbody>
<tr>
<td style="width: 48.0138%;">Модель</td>
<td style="width: 48.0138%;">YZYX130-8</td>
</tr>
<tr>
<td style="width: 48.0138%;">Обороты (r/min)</td>
<td style="width: 48.0138%;">32～40</td>
</tr>
<tr>
<td style="width: 48.0138%;">Двигатель（kW）</td>
<td style="width: 48.0138%;">10.15&nbsp;</td>
</tr>
<tr>
<td style="width: 48.0138%;">Размер（mm）</td>
<td style="width: 48.0138%;">18600&times;740&times;1275</td>
</tr>
<tr>
<td style="width: 48.0138%;">Масса（kg）</td>
<td style="width: 48.0138%;">680</td>
</tr>
</tbody>
</table>
<p><em>Примечание: Индивидуальная масса не включает электродвигатель.</em></p>
<p>&nbsp;</p>', true, true, false, 2, '2024-04-14 11:36:44', '2024-04-16 09:05:43');
INSERT INTO public.products VALUES (7, 'Маслопресс YZYX140CJGX', 'maslopress-yzyx140-cjgx', '["products\/YZYX140-8GZ.png","products\/YZYX140-8GZ-1.png","products\/YZYX140-8GZ-4.png","products\/YZYX140-8GZ-3.png","products\/YZYX140-8GZ-2.png"]', '<p>Наша компания производит спиральные масляные станки серии YZYX140, которые отвечают потребностям развития масляной промышленности и подходят для использования малыми и средними масляными заводами и поселковыми предприятиями.&nbsp; Эта модель подходит для прессования семян рапса, хлопковых семян, соевых бобов, арахисовых орехов, семян кунжута, семян тунга, семян подсолнечника и пальмового ореха и других растительных масел.&nbsp; Продукция имеет преимущества небольших инвестиций, большой производительности, простой поддержки, простоты обслуживания, сильной адаптации и высокой эффективности выхода нефти.</p>
<p>YZYX140CJGX представляет собой четырехступенчатый прессовочный станок с удлиненным отжимным устройством и большой топливный бак, механизм замедления которого представляет собой косозубую передачу, работает плавно, увеличивает прочность передачи, снижает шум и продлевает срок службы.</p>
<p><img src="../../../app/products/hK6ZztsZWXJ8IfVW7b4NKSXOm5Kf2oR0yARUEjVX.png" alt="" width="100%" /></p>
<p><strong>Основные характеристики:</strong></p>
<p>Следующие параметры производительности относятся к семенам масличных культур среднего или выше уровня качества, которые могут быть достигнуты во время непрерывного горячего прессования после того, как операция прессования является нормальной и вспомогательное оборудование, такое как очистка, шелушение, дробление, прокатка, пропаривание и жарка, завершено, а также принят разумный процесс прессования.</p>
<table style="border-collapse: collapse; width: 100%; height: 223.906px;" border="1">
<tbody>
...
<tr style="height: 22.3906px;">
<td style="width: 19.255%; height: 22.3906px;">рапс</td>
<td style="width: 19.255%; height: 22.3906px;">9 ~ 11</td>
<td style="width: 19.255%; height: 22.3906px;">&le; 7.6</td>
<td style="width: 19.255%; height: 22.3906px;">&ge; 82</td>
<td style="width: 19.2575%; height: 22.3906px;">&le; 34</td>
</tr>
...
<tr style="height: 22.3906px;">
<td style="width: 19.255%; height: 22.3906px;">соевые бобы</td>
<td style="width: 19.255%; height: 22.3906px;">8 ~ 10</td>
<td style="width: 19.255%; height: 22.3906px;">&le; 6.5</td>
<td style="width: 19.255%; height: 22.3906px;">&ge; 67</td>
<td style="width: 19.2575%; height: 22.3906px;">&le; 51</td>
</tr>
...
<tr style="height: 44.7812px;">
<td style="width: 19.255%; height: 44.7812px;">семя подсолничника</td>
<td style="width: 19.255%; height: 44.7812px;">9 ~ 11</td>
<td style="width: 19.255%; height: 44.7812px;">&le; 7.6</td>
<td style="width: 19.255%; height: 44.7812px;">&ge; 82</td>
<td style="width: 19.2575%; height: 44.7812px;">&le; 34</td>
</tr>
...
<tr>
<td style="width: 48.0138%;">Модель</td>
<td style="width: 48.0138%;">YZYX140CJGX</td>
</tr>
<tr>
<td style="width: 48.0138%;">Обороты (r/min)</td>
<td style="width: 48.0138%;">30～40</td>
</tr>
<tr>
<td style="width: 48.0138%;">Двигатель（kW）</td>
<td style="width: 48.0138%;">18.5 или 22&nbsp;</td>
</tr>
<tr>
<td style="width: 48.0138%;">Размер（mm）</td>
<td style="width: 48.0138%;">2300 &times; 820 &times; 1370</td>
</tr>
<tr>
<td style="width: 48.0138%;">Масса（kg）</td>
<td style="width: 48.0138%;">1100</td>
</tr>
</tbody>
</table>
<p><em>Примечание: Индивидуальная масса не включает электродвигатель.</em></p>
<p>&nbsp;</p>', true, true, false, 2, '2024-04-14 11:36:44', '2024-04-17 03:21:16');
INSERT INTO public.products VALUES (5, 'Маслопресс YZYX130-9', 'maslopress-yzyx130-9', '["products\/YZYX130-9-2.png","products\/YZYX130-9-3.png","products\/YZYX130-9.jpg","products\/YZYX130-9-1.png"]', '<p>Наша компания производит спиральные масляные станки серии YZYX140, которые отвечают потребностям развития масляной промышленности и идеально подходят для использования малыми и средними масляными заводами и поселковыми предприятиями.&nbsp;</p>
<p>Эта модель предназначена для прессования семян рапса, хлопковых семян, соевых бобов, арахисовых орехов, семян кунжута, семян тунга, семян подсолнечника и пальмового ореха и других растительных масел.</p>
<p>Продукция имеет преимущества небольших инвестиций, большой производительности, простой поддержки, простоты обслуживания, сильной адаптации и высокой эффективности выхода масла.</p>
<p>YZYX130 - 9 для удлиненного отжимного станка с трехступенчатым прессованием, коэффициент сжатия отжимного станка соответственно увеличивается, подходит для накопления определенного опыта использования, с акцентом на остаточное масло сухих пирожных.</p>
...
<tr style="height: 22.3906px;">
<td style="width: 19.255%; height: 22.3906px;">рапс</td>
<td style="width: 19.255%; height: 22.3906px;">&ge; 8</td>
<td style="width: 19.255%; height: 22.3906px;">&le; 7.6</td>
<td style="width: 19.255%; height: 22.3906px;">&ge; 82</td>
<td style="width: 19.2575%; height: 22.3906px;">&le; 34</td>
</tr>
...
<tr style="height: 22.3906px;">
<td style="width: 19.255%; height: 22.3906px;">соевые бобы</td>
<td style="width: 19.255%; height: 22.3906px;">&ge; 7</td>
<td style="width: 19.255%; height: 22.3906px;">&le; 6.5</td>
<td style="width: 19.255%; height: 22.3906px;">&ge; 67</td>
<td style="width: 19.2575%; height: 22.3906px;">&le; 51</td>
</tr>
...
<tr style="height: 44.7812px;">
<td style="width: 19.255%; height: 44.7812px;">семя подсолничника</td>
<td style="width: 19.255%; height: 44.7812px;">&ge; 8</td>
<td style="width: 19.255%; height: 44.7812px;">&le; 7.6</td>
<td style="width: 19.255%; height: 44.7812px;">&ge; 82</td>
<td style="width: 19.2575%; height: 44.7812px;">&le; 34</td>
</tr>
...
<tr>
<td style="width: 48.0138%;">Обороты (r/min)</td>
<td style="width: 48.0138%;">28～40</td>
</tr>
<tr>
<td style="width: 48.0138%;">Двигатель（kW）</td>
<td style="width: 48.0138%;">15（Y160L-4）或18.5（Y180M-4）&nbsp;</td>
</tr>
<tr>
<td style="width: 48.0138%;">Размер（mm）</td>
<td style="width: 48.0138%;">2020&times;742&times;1420</td>
</tr>
<tr>
<td style="width: 48.0138%;">Масса（kg）</td>
<td style="width: 48.0138%;">886（进）</td>
</tr>
</tbody>
</table>
<p><em>Примечание: Индивидуальная масса не включает электродвигатель.</em></p>
<p><iframe src="https://www.youtube.com/embed/9sRBLk6VBnM?si=FmlHE7U01SDbzsFY" width="560" height="314" allowfullscreen="allowfullscreen"> </iframe></p>', true, true, false, 2, '2024-04-14 11:36:44', '2024-04-15 12:49:34');
INSERT INTO public.products VALUES (8, 'Маслопресс YZYX140-8', 'maslopress-yzyx140-8', '["products\/YZYX140-8.png","products\/YZYX140-8-2.png","products\/YZYX140-8-3.png","products\/YZYX140-8-1.png"]', '<p>Наша компания производит спиральные масляные станки серии YZYX140, которые отвечают потребностям развития масляной промышленности и подходят для использования малыми и средними масляными заводами и поселковыми предприятиями.&nbsp; Эта модель подходит для прессования семян рапса, хлопковых семян, соевых бобов, арахисовых орехов, семян кунжута, семян тунга, семян подсолнечника и пальмового ореха и других растительных масел.&nbsp; Продукция имеет преимущества небольших инвестиций, большой производительности, простой поддержки, простоты обслуживания, сильной адаптации и высокой эффективности выхода нефти.</p>
<p>Тип YZYX140 представляет собой трехступенчатый прессовочный спиральный пресс + большой топливный бак с соответствующим увеличением коэффициента сжатия в выжимном отверстии, подходящий для накопления определенного опыта использования, с акцентом на остаточном масле сухого пирога.&nbsp;</p>
<p><strong>Основные характеристики:</strong></p>
<p>Следующие параметры производительности относятся к семенам масличных культур среднего или выше уровня качества, которые могут быть достигнуты во время непрерывного горячего прессования после того, как операция прессования является нормальной и вспомогательное оборудование, такое как очистка, шелушение, дробление, прокатка, пропаривание и жарка, завершено, а также принят разумный процесс прессования.</p>
<table style="border-collapse: collapse; width: 100%; height: 223.906px;" border="1">
<tbody>
...
<tr>
<td style="width: 48.0138%;">Обороты (r/min)</td>
<td style="width: 48.0138%;">28～38</td>
</tr>
<tr>
<td style="width: 48.0138%;">Двигатель（kW）</td>
<td style="width: 48.0138%;">18.5 или 22&nbsp;</td>
...
<tr>
<td style="width: 48.0138%;">Размер（mm）</td>
<td style="width: 48.0138%;">2010 &times; 690 &times; 1430</td>
</tr>
<tr>
<td style="width: 48.0138%;">Масса（kg）</td>
<td style="width: 48.0138%;">806</td>
</tr>
</tbody>
</table>
<p><em>Примечание: Индивидуальная масса не включает электродвигатель.</em></p>
<p>&nbsp;</p>', true, true, false, 2, '2024-04-14 11:36:44', '2024-04-17 03:36:07');
INSERT INTO public.products VALUES (9, 'Маслопресс YZYX95C', 'maslopress-yzyx95', '["products\/YZYX95C.png","products\/YZYX95C-3.png","products\/YZYX95C-2.png","products\/YZYX95C-1.png"]', '<p>Спиральные масляные станки серии YZYX95C, выпускаемые нашей компанией, подходят для прессования различных растительных масел, таких как рапс, хлопчатобумажные семена, соевыебобы, орех арахиса, семена хума, семена тунга, семена подсолнечника и пальмовое ядро.&nbsp; Продукция имеет преимущества малого инвестирования, простой поддержки, простоты обслуживания, высокой адаптации к маслу, высокой эффективности выхода нефти, для средних и малых нефтяных заводов и поселковых индивидуальных предприятий очень подходит .</p>
<p>YZYX95C представляет собой трехступенчатый прессовочный спиральный пресс, подходящий для накопления определенного опыта использования, с акцентом на скорость остаточного масла сухих пирожных.</p>
<p>Наша компания эта серия моделей редукторов, постепенно была усовершенствована в редуктор с косозубым приводом, производительность сцепления зубьев хорошая, степень совпадения велика, улучшает несущую способность, так что передача редуктора стабильна, уменьшает шум, продлевает срок службы шестерни.</p>
<p><strong>Основные характеристики:</strong></p>
<p>Следующие параметры производительности относятся к семенам масличных культур среднего или выше уровня качества, которые могут быть достигнуты во время непрерывного горячего прессования после того, как операция прессования является нормальной и вспомогательное оборудование, такое как очистка, шелушение, дробление, прокатка, пропаривание и жарка, завершено, а также принят разумный процесс прессования.</p>
<table style="border-collapse: collapse; width: 100%; height: 223.906px;" border="1">
...
<tr style="height: 22.3906px;">
<td style="width: 19.255%; height: 22.3906px;">рапс</td>
<td style="width: 19.255%; height: 22.3906px;">&ge; 3.5</td>
<td style="width: 19.255%; height: 22.3906px;">&le; 7.8</td>
<td style="width: 19.255%; height: 22.3906px;">&ge; 81</td>
<td style="width: 19.2575%; height: 22.3906px;">&le; 34</td>
</tr>
<tr style="height: 22.3906px;">
<td style="width: 19.255%; height: 22.3906px;">семя хлопка</td>
<td style="width: 19.255%; height: 22.3906px;">&ge; 3.5</td>
<td style="width: 19.255%; height: 22.3906px;">&le; 7.3</td>
<td style="width: 19.255%; height: 22.3906px;">&ge; 76</td>
<td style="width: 19.2575%; height: 22.3906px;">&le; 54</td>
</tr>
<tr style="height: 22.3906px;">
<td style="width: 19.255%; height: 22.3906px;">соевые бобы</td>
<td style="width: 19.255%; height: 22.3906px;">&ge; 3.3</td>
<td style="width: 19.255%; height: 22.3906px;">&le; 6.8</td>
<td style="width: 19.255%; height: 22.3906px;">&ge; 66</td>
<td style="width: 19.2575%; height: 22.3906px;">&le; 51</td>
</tr>
<tr style="height: 22.3906px;">
<td style="width: 19.255%; height: 22.3906px;">ядро арахиса</td>
<td style="width: 19.255%; height: 22.3906px;">&ge; 3.5</td>
<td style="width: 19.255%; height: 22.3906px;">&le; 6.8</td>
<td style="width: 19.255%; height: 22.3906px;">&ge; 92</td>
<td style="width: 19.2575%; height: 22.3906px;">&le; 34</td>
</tr>
<tr style="height: 44.7812px;">
<td style="width: 19.255%; height: 44.7812px;">семя подсолничника</td>
<td style="width: 19.255%; height: 44.7812px;">&ge; 3.5</td>
<td style="width: 19.255%; height: 44.7812px;">&le; 7.8</td>
<td style="width: 19.255%; height: 44.7812px;">&ge; 81</td>
<td style="width: 19.2575%; height: 44.7812px;">&le; 34</td>
</tr>
<tr style="height: 22.3906px;">
<td style="width: 19.255%; height: 22.3906px;">лён</td>
...
<tr>
<td style="width: 48.0138%;">Модель</td>
<td style="width: 48.0138%;">YZYX95（C）</td>
</tr>
<tr>
<td style="width: 48.0138%;">Обороты (r/min)</td>
<td style="width: 48.0138%;">30～40</td>
...
<tr>
<td style="width: 48.0138%;">Двигатель（kW）</td>
<td style="width: 48.0138%;">7.5 bkb 11&nbsp;</td>
</tr>
<tr>
<td style="width: 48.0138%;">Размер（mm）</td>
<td style="width: 48.0138%;">1620&times;580&times;1195</td>
</tr>
<tr>
<td style="width: 48.0138%;">Масса（kg）</td>
<td style="width: 48.0138%;">570</td>
</tr>
</tbody>
</table>
<p><em>Примечание: Индивидуальная масса не включает электродвигатель.</em></p>
<p>&nbsp;</p>', true, true, false, 2, '2024-04-14 11:36:44', '2024-04-17 03:56:48');
INSERT INTO public.products VALUES (10, 'Маслопресс YZYX168', 'maslopress-yzyx168', '["products\/YZYX168.png","products\/YZYX168-2.png","products\/YZYX168-3.png","products\/YZYX168-1.png"]', '<p>Винтовой масляный пресс серии YZYX168 &mdash; это более крупный продукт, разработанный нашей компанией с целью адаптации к потребностям развития нефтеперерабатывающей промышленности и на основе постоянного обобщения практического производственного опыта. Его основными особенностями являются: большая производительность обработки, длинный ход прессования заготовки в камере прессования и дальнейшее увеличение давления в камере прессования, что повышает эффективность выхода масла и снижает расход остаточного масла сухого жмыха; в то же время изготавливаются изнашиваемые детали. из высококачественной легированной стали значительно увеличивает срок службы.</p>
<p>YZYX168 &mdash; удлиненная четырехступенчатая модель пресса (длина пресс-корпуса L1175). Подходит для отжима различных растительных масел, таких как рапсовое, хлопковое, соевое, арахисовое, льняное, тунговое, подсолнечное и пальмовое. Продукт обладает характеристиками низких инвестиций, большой производительности, простоты подбора, простоты обслуживания и высокой адаптируемости по сравнению с аналогичными машинами, представленными на рынке, он имеет значительные преимущества в виде высокой стоимости и особенно подходит для небольших и средних предприятий по переработке смазки. растения.</p>
<p><img src="../../../app/products/Luop0RY7RhSD7qdGvMqIJ5svZ2uTfOI51l1LxgYM.png" alt="" width="400" /></p>
<p><strong>Основные характеристики:</strong></p>
<p>Следующие параметры производительности относятся к семенам масличных культур среднего или выше уровня качества, которые могут быть достигнуты во время непрерывного горячего прессования после того, как операция прессования является нормальной и вспомогательное оборудование, такое как очистка, шелушение, дробление, прокатка, пропаривание и жарка, завершено, а также принят разумный процесс прессования.</p>
<table style="border-collapse: collapse; width: 100%; height: 223.906px;" border="1">
<tbody>
...
<tr style="height: 22.3906px;">
<td style="width: 19.255%; height: 22.3906px;">рапс</td>
<td style="width: 19.255%; height: 22.3906px;">&ge; 20</td>
<td style="width: 19.255%; height: 22.3906px;">&le; 7.4</td>
<td style="width: 19.255%; height: 22.3906px;">&ge; 84</td>
<td style="width: 19.2575%; height: 22.3906px;">&le; 34</td>
</tr>
<tr style="height: 22.3906px;">
<td style="width: 19.255%; height: 22.3906px;">семя хлопка</td>
<td style="width: 19.255%; height: 22.3906px;">&ge; 20</td>
<td style="width: 19.255%; height: 22.3906px;">&le; 6.3</td>
<td style="width: 19.255%; height: 22.3906px;">&ge; 80</td>
<td style="width: 19.2575%; height: 22.3906px;">&le; 54</td>
</tr>
<tr style="height: 22.3906px;">
<td style="width: 19.255%; height: 22.3906px;">соевые бобы</td>
<td style="width: 19.255%; height: 22.3906px;">&ge; 17</td>
<td style="width: 19.255%; height: 22.3906px;">&le; 6.2</td>
<td style="width: 19.255%; height: 22.3906px;">&ge; 69</td>
<td style="width: 19.2575%; height: 22.3906px;">&le; 51</td>
</tr>
<tr style="height: 22.3906px;">
<td style="width: 19.255%; height: 22.3906px;">ядро арахиса</td>
<td style="width: 19.255%; height: 22.3906px;">&ge; 20</td>
<td style="width: 19.255%; height: 22.3906px;">&le; 6.3</td>
<td style="width: 19.255%; height: 22.3906px;">&ge; 92.5</td>
<td style="width: 19.2575%; height: 22.3906px;">&le; 34</td>
</tr>
<tr style="height: 44.7812px;">
<td style="width: 19.255%; height: 44.7812px;">семя подсолничника</td>
<td style="width: 19.255%; height: 44.7812px;">&ge; 20</td>
<td style="width: 19.255%; height: 44.7812px;">&le; 7.4</td>
<td style="width: 19.255%; height: 44.7812px;">&ge; 84</td>
<td style="width: 19.2575%; height: 44.7812px;">&le; 34</td>
</tr>
<tr style="height: 22.3906px;">
<td style="width: 19.255%; height: 22.3906px;">лён</td>
...
<tr>
<td style="width: 48.0138%;">Модель</td>
<td style="width: 48.0138%;">YZYX168</td>
</tr>
<tr>
<td style="width: 48.0138%;">Обороты (r/min)</td>
<td style="width: 48.0138%;">32～38</td>
</tr>
<tr>
<td style="width: 48.0138%;">Двигатель（kW）</td>
<td style="width: 48.0138%;">&nbsp;</td>
</tr>
<tr>
<td style="width: 48.0138%;">Размер（mm）</td>
<td style="width: 48.0138%;">2670&times;1000&times;1726</td>
</tr>
<tr>
<td style="width: 48.0138%;">Масса（kg）</td>
<td style="width: 48.0138%;">1710</td>
</tr>
</tbody>
</table>
<p><em>Примечание: Индивидуальная масса не включает электродвигатель.</em></p>
<p>&nbsp;</p>', true, true, false, 2, '2024-04-14 11:36:44', '2024-04-17 04:11:29');
...
INSERT INTO public.sliders VALUES (2, 'ОБОРУДОВАНИЕ ДЛЯ ПРОИЗВОДСТВА МАСЛА', 'sliders/slider-榨油机1.jpg', '<p>Поставка, запчасти и сервисное обслуживание маслобойного оборудования. Проверенное оборудование от надёжных поставщиков</p>', 'Каталог продукции', 'catalog', 5, '2024-03-30 12:44:04', '2024-04-03 04:11:46');
INSERT INTO public.sliders VALUES (3, 'ОБОРУДОВАНИЕ ДЛЯ ПРОИЗВОДСТВА МАСЛА', 'sliders/slider-榨油机2.jpg', '<p>Поставка, запчасти и сервисное обслуживание маслобойного оборудования. Проверенное оборудование от надёжных поставщиков</p>', 'Каталог продукции', 'catalog', 3, '2024-03-30 12:44:04', '2024-04-03 04:13:34');
INSERT INTO public.sliders VALUES (1, 'ОБОРУДОВАНИЕ ДЛЯ ПРОИЗВОДСТВА МАСЛА', 'sliders/slider-榨油机.jpg', '<p>Поставка, запчасти и сервисное обслуживание маслобойного оборудования. Проверенное оборудование от надёжных поставщиков</p>', 'Продукция', 'catalog', 1, '2024-03-30 12:44:04', '2024-04-03 04:13:59');
